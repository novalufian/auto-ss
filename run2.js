...
const _input = require('./app/libs/input.json');

// init 
_input.input.map(async function (data) {
    await get_config(data.type,data.site ,data.placement)
    await console.log(data.site)
})
